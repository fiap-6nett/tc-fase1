...
namespace uBee.Domain.Core.Utility
{
    public static class Ensure
    {
        ...
        public static void LessThan(DateTime value, DateTime maxValue, string message, string argumentName)
        {
            if (value >= maxValue)
                throw new ArgumentException(message, argumentName);
        }
        ...
        public static void LessThanOrEqual(DateTime value, DateTime maxValue, string message, string argumentName)
        {
            if (value > maxValue)
                throw new ArgumentException(message, argumentName);
        }
        ...
        public static void GreaterThan(decimal value, int minValue, string message, string argumentName)
        {
            if (value <= minValue)
                throw new ArgumentException(message, argumentName);
        }
        ...
        public static void GreaterThanOrEqual(DateTime value, DateTime minValue, string message, string argumentName)
        {
            if (value < minValue)
                throw new ArgumentException(message, argumentName);
        }
